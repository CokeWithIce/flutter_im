              ...
              child:Row(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Image.asset('images/icon-test.png',width: 70.0,height: 70.0,),
                  ),
                  Expanded(
                    child: Column(
                  ...
                  Container(
                    margin:const EdgeInsets.only(left:12.0,right:15.0),
                    child:Image.asset('images/icon-test-copy.png',width:24.0,height:24.0,)
                  )
                ],
              ),
              onPressed: (){},
